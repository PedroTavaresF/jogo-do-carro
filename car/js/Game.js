class Game {
    constructor (){
        this.resetTitle = createElemente("h2") ; 
    ...
    update (state){
        ...
        start(){
            ...
            car1.addImgae("blast",blastImage);
        ...
        handleElements(){
            ...
            this.resetButton.class("resteButton")
            this.resetButton.position(width/ 2  + 230, 100)

            this.leaderboardtitle.html("Placar")
            this.leaderboardtitle.class("resetText")
            this.leaderboardtitle.position (width / 3 - 50, 80)
        ...
        if (allPlayers !==  undefined){
            ...
            for (var plr in allPlayers){
                ...
                if ( index=== player.index) {
                    ...
                    this.handleObstacleCollisiob(index)
...
showFuelBar(){
   ...
   showLeadeboard(){
    var leader1, leader2
    var players = Objetc.values(allPlayers)
    if( 
